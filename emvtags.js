...
{"tag" : "9F05","name" : "Application Discretionary Data","description" : "Issuer or payment system specified data relating to the application","source" : "ICC","format" : "b","template" : "70' or '77","length" : "1-32"},
...
{"tag" : "4F","name" : "Application Dedicated File (ADF) Name","description" : "Identifies the application as described in ISO/IEC 7816-5","source" : "ICC","format" : "b","template" : "61","length" : "5-16"},
{"tag" : "9F06","name" : "Application Identifier (AID) – terminal","description" : "Identifies the application as described in ISO/IEC 7816-5","source" : "Terminal","format" : "b","template" : "—","length" : "5-16"},
...
{"tag" : "50","name" : "Application Label","description" : "Mnemonic associated with the AID according to ISO/IEC 7816-5","source" : "ICC","format" : "ans with the special character limited to space","template" : "61' or 'A5","length" : "1-16"},
{"tag" : "9F12","name" : "Application Preferred Name","description" : "Preferred mnemonic associated with the AID","source" : "ICC","format" : "ans (see section 4.3)","template" : "61' or 'A5","length" : "1-16"},
...
{"tag" : "9F3B","name" : "Application Reference Currency","description" : "1-4 currency codes used between the terminal and the ICC when the Transaction Currency Code is different from the Application Currency Code; each code is 3 digits according to ISO 4217","source" : "ICC","format" : "n3","template" : "70' or '77","length" : "2-8"},
{"tag" : "9F43","name" : "Application Reference Currency Exponent","description" : "Indicates the implied position of the decimal point from the right of the amount, for each of the 1-4 reference currencies represented according to ISO 4217","source" : "ICC","format" : "n1","template" : "70' or '77","length" : "1-4"},
...
{"tag" : "5F20","name" : "Cardholder Name","description" : "Indicates cardholder name according to ISO 7813","source" : "ICC","format" : "ans 2-26","template" : "70' or '77","length" : "2-26"},
...
{"tag" : "9D","name" : "Directory Definition File (DDF) Name","description" : "Identifies the name of a DF associated with a directory","source" : "ICC","format" : "b","template" : "61","length" : "5-16"},
...
{"tag" : "9F4C","name" : "ICC Dynamic Number","description" : "Time-variant number generated by the ICC, to be captured by the terminal","source" : "ICC","format" : "b","template" : "—","length" : "2-8"},
...
{"tag" : "91","name" : "Issuer Authentication Data","description" : "Data sent to the ICC for online issuer authentication","source" : "Issuer","format" : "b","template" : "—","length" : "8-16"},
...
{"tag" : "5F2D","name" : "Language Preference","description" : "1-4 languages stored in order of preference, each represented by 2 alphabetical characters according to ISO 639\nNote: EMVCo strongly recommends that cards be personalised with data element '5F2D' coded in lowercase, but that terminals accept the data element whether it is coded in upper or lower case.","source" : "ICC","format" : "an 2","template" : "A5","length" : "2-8"},
...
{"tag" : "9F1D","name" : "Terminal Risk Management Data","description" : "Application-specific value used by the card for risk management purposes","source" : "Terminal","format" : "b","template" : "—","length" : "1-8"},
...
{"tag" : "9F41","name" : "Transaction Sequence Counter","description" : "Counter maintained by the terminal that is incremented by one for each transaction","source" : "Terminal","format" : "n 4-8","template" : "—","length" : "2-4"},
